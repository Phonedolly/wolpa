...
public final class RenderView: NSView {
    ...
    override public func scrollWheel(with event: NSEvent) {
        ...
        for _ in 0..<dirX.1 { dirX.0.withCString { b in "press".withCString { a in wolpa_mouse(c, b, a, row, col) } } }
        for _ in 0..<dirY.1 { dirY.0.withCString { b in "press".withCString { a in wolpa_mouse(c, b, a, row, col) } } }
    }
    ...
    override public func keyDown(with event: NSEvent) {
        ...
        if event.modifierFlags.contains(.command) {
            ...
            case 24: fontPtSize = min(32, fontPtSize + 2); wolpa_set_font_size(c, fontPtSize); updateDrawableSize(); return
            case 27: fontPtSize = max(8, fontPtSize - 2); wolpa_set_font_size(c, fontPtSize); updateDrawableSize(); return
            default: break
            }
        }
